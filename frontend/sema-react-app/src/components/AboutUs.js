  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: "0", backgroundColor: "#E3F2FD" }}>
      ...
      <section style={{ padding: "80px 20px", backgroundColor: "#0072C6", color: "white", textAlign: "center" }}>
        <h1 style={{ fontSize: "3rem", fontWeight: "bold", marginBottom: "20px" }}>{t('about.title')}</h1>
      ...
      <section style={{ textAlign: "center", padding: "60px 20px", backgroundColor: "#FFFFFF", borderTop: "10px solidrgb(134, 186, 223)", borderBottom: "10px solid #0072C6" }}>
        <h2 style={{ color: "#0072C6", fontSize: "2.5rem", fontWeight: "600", marginBottom: "20px" }}>{t('about.mission')}</h2>
      ...
      <section style={{ padding: "50px 20px", backgroundColor: "#BFD8FF", textAlign: "center" }}>
        <h2 style={{ color: "#0072C6", fontSize: "2.5rem", fontWeight: "600", marginBottom: "20px" }}>{t('about.contact')}</h2>
        <p style={{ fontSize: "1.2rem", marginBottom: "20px", color: "#6C757D" }}>{t('about.contactText')}</p>
        <p style={{ fontSize: "1.2rem", marginBottom: "10px" }}>{t('about.email')} <a href="mailto:support@semamama.com" style={{ color: "#0072C6", textDecoration: "underline" }}>support@semamama.com</a></p>
        <p style={{ fontSize: "1.2rem", color: "#6C757D" }}>{t('about.phone')} +123 456 7890</p>
      </section>
